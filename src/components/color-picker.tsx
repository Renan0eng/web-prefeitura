      ...
      <PopoverContent className="w-64">
        <Tabs defaultValue="solid" className="w-full">
          ...
          <div className="mt-4 flex items-center gap-2">
            <div className="h-10 w-10 rounded-md border" style={{ backgroundColor: currentColor }} />
            <div className="flex flex-col flex-1 gap-1">
              <div className="flex items-center gap-2">
                <Input readOnly value={currentColor} className="h-8" />
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => copyToClipboard(currentColor)}>
